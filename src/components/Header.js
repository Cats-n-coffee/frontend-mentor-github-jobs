...
import { ToggleSwitchContainer, ToggleButton, ToggleDiv } from './headerToggle';
...
const ToggleButtonSwitch = styled(ToggleButton)`
    &:before {
        transform: ${ ({ toggled }) => toggled ? 'translateX(24px)' : 'translateX(0px)' };
    }
`;
                ...
                <HeaderContent>
                    ...
                    <ToggleSwitchContainer>
                        <IconToggle width="20" height="19" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 19">
                            ...
                            <ToggleDiv className="switch-color-mode">
                                <ToggleButtonSwitch 
                                    id="light-dark-mode" 
                                    toggled={ toggled }
