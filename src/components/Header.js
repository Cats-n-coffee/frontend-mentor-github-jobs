    ...
    return ( 
        <HeaderStyled>
            <HeaderContent>
                ...
                <fieldset>
                    <label htmlFor="light-mode" className="switch-color-mode">
                        <svg width="20" height="19" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 19">
                    ...
                    <input type="radio" name="color-switch" id="light-mode" value="light-mode"/>
                    <input type="radio" name="color-switch" id="dark-mode" value="dark-mode"/>
                    <label htmlFor="dark-mode" className="dark-mode">
