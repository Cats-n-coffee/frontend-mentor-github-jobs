...
import { ToggleLabel, ToggleSwitchContainer, ToggleButton, SliderSpan } from './headerToggle';

const HeaderStyled = styled.header` 
    padding: 2em ${(props) => props.theme.padding.paddingMobile} 4em;
    position: relative;
    z-index: 1;
    overflow: hidden;
...
const HeaderContent = styled(DesktopWrapper)`
    display: flex;
    justify-content: space-between;
`;

const IconToggle = styled.svg`
    &:first-of-type {
        margin: 0 1em 0 0;
    }
